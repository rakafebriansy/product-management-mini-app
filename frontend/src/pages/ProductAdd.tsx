  ...
  return (
    <div className="max-w-2xl mx-auto animate-in">
      <div className="mb-12">
        ...
        <h2 className="text-4xl font-black tracking-tighter">Tambah Produk</h2>
        <p className="text-muted-foreground mt-2 font-medium">Masukkan detail produk baru ke dalam sistem.</p>
      </div>
      ...
      <div className="premium-card p-8 md:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex items-center justify-end gap-6 pt-6">
            ...
            >
              {loading && <div className="w-4 h-4 border-2 border-white/20 border-t-white rounded-full animate-spin mr-2"></div>}
